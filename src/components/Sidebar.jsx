...
const Sidebar = () => {
  return (
    <section className='max-w-[420px] min-w-[350px] flex flex-col gap-2'>
...
<div className='flex flex-col h-screen  bg-white/10 text-white p-2 rounded-lg w-full'>
       ...
       <SidebarLibrary heading={'Create your first playlist'} text={"It's easy we'll help you"} button={'Create playlist'}/>
       <SidebarLibrary heading={"Let's find some podcasts to follow"} text={"We'll keep you updated on new episodes"} button={'Browse podcasts'}/>
       </div>
